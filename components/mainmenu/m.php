...
require_once($XELAVAARKISTODIR.'libs/mvc/m.php');
class MainMenuXElavaArkistoModel extends XElavaArkistoModel {
	function getMenuItems() {
		...
		$mainmenudoc->load( $XELAVAARKISTODIR."components/mainmenu/mainmenu.xml" );
